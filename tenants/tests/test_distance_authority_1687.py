...
ALLOWED_READERS = {
    ...
    "users/personal_data_api.py": "выгрузка субъекту по 152-ФЗ (C5.1, DRF-1918): только чтение значения, "
    "чтобы отдать человеку его же данные; расстояние не считает, не фильтрует, наружу не показывает",
}
