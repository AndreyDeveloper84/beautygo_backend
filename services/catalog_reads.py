...
**Роль в конвейере: FILTERING и PRESENTATION** (DRF-1628). Модуль сужает
множество и раскладывает строки по ``sort_order``; семантического
порядка не задаёт и задавать не вправе.
