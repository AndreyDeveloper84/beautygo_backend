...
class NutritionProfile(models.Model):
    ...
    #
    # Названный предел: ``0017`` возражала и против пустого поля — оно
    # неотличимо от «миграция не доехала». Здесь отличие держит не
    # значение, а сторож: ``nutrition/tests/test_per_kind_provenance_backfill_decision.py``
    # КРАСНЫЙ, пока владелец не выбрал умолчание для существующих строк.
    # Отсутствие решения видно, а не подставлено молча.
