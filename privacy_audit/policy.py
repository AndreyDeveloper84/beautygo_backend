...
An unaudited operation is not permitted to become an unrecorded one. What
changes for a queued operation is WHEN the record lands, never WHETHER. See
:mod:`privacy_audit.spool` — including why the queue must not share a failure
mode with the thing it insures.
"""
