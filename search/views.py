...
**Роль в конвейере: RETRIEVAL** (DRF-1628). Свой порядок здесь законен и
уничтожать его не надо — это релевантность выборки, а не утверждение о
том, что человеку подходит. Граница проходит не по сортировке, а по
тому, становится ли этот порядок ответом на «что Ayla рекомендует»:
становиться он не вправе.
